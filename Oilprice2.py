...
while True:
    if y == 1:
        ...
        print('::' + ' '*76 + '::')
        print('::' + ' '*20 + 
              'WELCOM TOTHE KITTIKHUN GASS TATION' + ' '*22 + '::')
        print('::' + ' '*76 + '::')
        print('::' + ' '*76 + '::')
        print('::' + ' '*76 + '::')
        print('::' + ' '*76 + '::')
        ...
        print('::' + ' '*76 + '::')
        print('::' + ' '*76 + '::')
        print('::' + ' '*24 + "1.Gasoline 95 price" + ' ' +
              ' %.2f' % (price_oil["Gasoline 95"]) + ' '+'Baht' + ' '*21 +'::')
        print('::' + ' '*24 + "2.Gasoline 91 price" + ' ' + 
              ' %.2f' % (price_oil["Gasoline 91"]) + ' '+'Baht' + ' '*21 +'::')
        print('::' + ' '*24 + "3.Gasohol 91  price" + ' ' +
              ' %.2f' % (price_oil["Gasohol 91"]) + ' '+'Baht' + ' '*21 +'::')
        print('::' + ' '*24 + "4.Gasohol E20 price" + ' ' +
              ' %.2f' % (price_oil["Gasohol E20"]) + ' '+'Baht' + ' '*21 +'::')
        print('::' + ' '*24 + "5.Gasohol 95  price" + ' ' + 
              ' %.2f' % (price_oil["Gasohol 95"]) + ' '+'Baht' + ' '*21 +'::')
        print('::' + ' '*24 + "6.Diesel      price" + ' ' +
              ' %.2f' % (price_oil["Diesel"]) + ' '+'Baht' + ' '*21 +'::')
        print('::' + ' '*76 + '::')
        print('::' + ' '*76 + '::')
        print('::' + ' '*76 + '::')
        print('::' + ' '*76 + '::')
